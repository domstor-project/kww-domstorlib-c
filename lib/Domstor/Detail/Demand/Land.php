...
class Domstor_Detail_Demand_Land extends Domstor_Detail_Demand
{
    ...
    public function getLocation()
    {
        ...
        if ($this->in_region) {
            ...
            if ($this->getVar('cooperative_name')) {
                $out.= $this->getVar('cooperative_name').', ';
            }
            if ($this->getVar('city')) {
                $out.= $this->getVar('city').', ';
            }
            if ($this->getVar('region')) {
                $out.= $this->getVar('region').', ';
            }
        } else {
            if ($this->getVar('street')) {
                $out.= $this->getVar('street').', ';
            }
            if ($this->getVar('cooperative_name')) {
                $out.= $this->getVar('cooperative_name').', ';
            }
            if ($this->getVar('district')) {
                $out.= $this->getVar('district').', ';
            }
            if ($this->getVar('city')) {
                $out.= $this->getVar('city').', ';
            }
    ...
    public function getAnnotation()
    {
        ...
        if ($this->getVar('land_type')) {
            $annotation.=', '.$this->getVar('land_type');
        }
    ...
    public function getTechnicBlock()
    {
        ...
        if ($electro) {
            $out = $this->getElement('Электроснабжение:', '').$electro;
        }
